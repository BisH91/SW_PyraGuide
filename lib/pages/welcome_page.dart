...
class WelcomePagee extends StatefulWidget {
  const WelcomePagee({Key? key}) : super(key: key);
  @override
  _WelcomePageeState createState() => _WelcomePageeState();
}

class _WelcomePageeState extends State<WelcomePagee> {
  List images = [
    "welcome-one.png",
    "welcome-two.png",
    "welcome-three.png",
